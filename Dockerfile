...
RUN apk add php7 php7-json php7-mongodb php7-phar php7-mbstring php7-iconv php7-openssl php7-tokenizer php7-pdo php7-pdo_mysql php7-session php7-mysqli php7-sqlite3 php7-pdo_sqlite php7-ctype php7-simplexml php7-xmlwriter
